...
import type { ImportQuestionsResult, Question, QuestionCategory, QuestionFilters, QuestionSubcategory } from "./question.types";
...
export interface IQuestionRepository {
  ...
  uploadExcel(file: File, subcategoryId?: string): Promise<ApiResponse<ImportQuestionsResult>>;
